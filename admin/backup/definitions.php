...
$_PMBP_EXPORT_DIR="../../../../../webdata/myapps/backups/";   // example: $_PMBP_EXPORT_DIR="../../files/export/";
...
if (isset($_POST['lang']) && preg_replace("/.*/i","",$_SERVER['PHP_SELF'])=="config.php") $CONF['lang']=$_POST['lang'];
