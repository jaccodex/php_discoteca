...
class mysqliDb
{
    ...
    /**
     *
     * devuelve un array con resultados de una select. Usa prepared statements.
     * 
     * @param array $parametros solo se usa cuando se utilizan variables en prepared statements
    ...
    /**
     * Inserta datos en una tabla utilizando prepared statements 
     * @param string $table nombre de la tabla donde se hace el INSERT
     * @param array $datos  array con los datos que se van a insertar. el indice es el nombre del campo, y el valor, el dato a insertar
     */
    ...
    protected function _executeQuery($parametros)
    {
        try
        {
            $this->_stmt->execute();
        ...
        {
            $userMessage='Se ha producido un error al ejecutar la consulta con la base de datos.';
            $this->_showMySqliError($userMessage);
...
protected function _dynamicBindParams($parametros)
{
    //bind parameters
    ...
    foreach($parametros as $key=>$valor)
    {
        ...
        //$parametros[$key]="'{$valor}'";//meto los valores entre comillas
    }
    ...
    catch(Exception $e ) 
    {
        ...
        $userMessage='Se ha producido un error en la consulta con la base de datos (bind_param).';
        $this->_showMySqliError($userMessage);
...
protected function _dynamicBindResults() 
{
    ...
    */            
    ...
    catch(Exception $e ) 
    {
        ...
        $userMessage='Se ha producido un error en la consulta con la base de datos (bind_result).';
        $this->_showMySqliError($userMessage);
